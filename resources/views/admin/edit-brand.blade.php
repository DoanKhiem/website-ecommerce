                    ...
                    <form class="row" action="{{route('brand.update', $brand->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$brand->name}}" name="name" placeholder="Nhập tên sản phảm" type="text" class="mb-2 form-control">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input name="status" type="radio" value="0" {{$brand->status == 0 ? 'checked' : ''}}>
                                    Ẩn
                                </div>
                                <div class="radio">
                                    <input name="status" type="radio" value="1" {{$brand->status == 1 ? 'checked' : ''}}>
                                    Hiện
                                </div>
                            </div>
{{--                            <div class="form-group">--}}
{{--                                <label  class="">Đường dẫn</label>--}}
{{--                                <input value="{{$brand->slug}}" name="slug" placeholder="Nhập ram" type="text" class="mb-2 form-control">--}}
{{--                            </div>--}}
                            <div class="position-relative form-group">
                                <label  class="">Logo thương hiệu</label>
                                <img src="{{url('uploads')}}/{{$brand->logo}}" alt="" style="width: 200px;">
