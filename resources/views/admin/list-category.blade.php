            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    justify-content: space-between; flex-direction: row; align-items: flex-end;">
                        <h5 class="card-title" style="">Danh sách danh mục</h5>
                        <form action="" style="">
                    ...
                    <table class="mb-0 table table-hover">
                        ...
                        @forelse($category as $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.delete-category', $value->id)}}"
                                       onclick="return confirm('Bạn có chắc muốn xóa {{$value->name}} không?')"
                        ...
                        @empty
                            <tr>
                                <th colspan="7" style="text-align: center">Không có thương hiệu nào</th>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
