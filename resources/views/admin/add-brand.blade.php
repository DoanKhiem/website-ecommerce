                    ...
                    <form class="row" action="{{route('brand.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="name" placeholder="Nhập tên thương hiệu" type="text" class="mb-2 form-control">
                                @if ($errors->has('name'))
...
{{--                                <input name="slug" placeholder="Nhập đường dẫn url" type="text" class="mb-2 form-control">--}}
{{--                            </div>--}}
                            {{--                                <div class="form-group">--}}
