...
//        }
        ...
        if ($category){
            return redirect()->route('admin.list-category')->with('success',"Thêm mới danh mục $category->name thành công");
        }else{
            return redirect()->route('admin.list-category')->with('success',"Thêm mới danh mục $category->name thất bại");
...
//        }
        ...
        if ($category){
            ...
            return redirect()->route('admin.list-category')->with('errors',"Lỗi sửa danh mục $category->name");
        }
    }
    ...
    public function delete($id){
        ...
        if ($category->numberOfProducts->count() > 0){
            return redirect()->route('admin.list-category')->with('errors',"Không thể xóa danh mục này $category->name");
        } else{
            $category->delete();
